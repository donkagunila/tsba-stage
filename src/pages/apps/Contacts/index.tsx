...
import MapsHolder from "../../../components/base/Maps";

const Contacts = () => {
    return (
        <div>
            <PageHeader title={"Contacts"} className={"bg-white px-4"}/>
                ...
                <div className="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:items-stretch md:grid-cols-2 gap-x-12 lg:gap-x-20 gap-y-10">
                        <div className="flex flex-col justify-between lg:py-5">
                            <div>
                                <h2 className="text-3xl font-bold leading-tight text-white sm:text-4xl lg:leading-tight lg:text-5xl">
                                    It’s time to connect, Lets work together</h2>
                                <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-white">
                                    Welcome decision makers, governmental departments, non-governmental institutions and
                                    Individuals.. Let's Connect
                                </p>

                                <img className="relative z-10 max-w-xs mx-auto -mb-16 md:hidden"
                                     src="https://cdn.rareblocks.xyz/collection/celebration/images/contact/4/curve-line-mobile.svg"
                                     alt=""/>

                                <img className="hidden w-full translate-x-24 translate-y-8 md:block"
                            ...
                            <div className="hidden md:mt-auto md:block">
                                <div className="flex items-center">
                                    <svg className="w-6 h-6 text-yellow-400" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <blockquote className="mt-6">
                                    <p className="text-lg leading-relaxed text-white">
                                        Tanzanian regulation must account for a high level of consumer protection,
                                        taking into account the existence of a digital economy and high consumer
                                        expectation..</p>
                                </blockquote>
                                ...
                                <div className="flex items-center mt-8">
                                    <img className="flex-shrink-0 object-cover w-10 h-10 rounded-full"
                                         ...
                                         alt=""/>
                                    <div className="ml-4">
                                        <p className="text-base font-semibold text-white">John Kokusima Muloki</p>
                        ...
                        <div className="lg:pl-12">
                            <div className="overflow-hidden bg-white rounded-md">
                                <div className="p-6 sm:p-10">
                                    <h3 className="text-3xl font-semibold text-black">Lets Connect</h3>
                                    <p className="mt-4 text-base text-gray-600">
                                        For any Inqueries, Comment, Connection, reach out
                                    </p>
                                    ...
                                    <form action="#" method="POST" className="mt-4">
                                        ...
                                        ></textarea>
                                            ...
                                            <div>
                                                <button type="submit"
                                                        className="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 bg-amber-500 border border-transparent rounded-md focus:outline-none hover:bg-orange-600 focus:bg-orange-600">
                                                    Submit
                                                </button>
                                            </div>
                                        </div>
                        ...
                        <div className="md:hidden">
                            ...
                            <blockquote className="mt-6">
                                <p className="text-lg leading-relaxed text-white">You made it so simple. My new site is
                                    so
                                    much faster and easier to work with than my old site. I just choose the page, make
                                    the change and click save.</p>
                            </blockquote>
