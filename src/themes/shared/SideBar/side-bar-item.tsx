    ...
    return (
        <li>
            ...
            <Item menu={props.menu}
                  level={"first"}
                setFormattedMenu={props.setFormattedMenu}></Item>
...
function Item (props: {
    ...
    return <div className={twMerge([
        "cursor-pointer flex justify-center items-center md:gap-2 px-3 py-2.5 rounded-md text-white dark:text-slate-400 transition-all border border-transparent",
       clsx( {
            "bg-white/10 border border-white/30 dark:bg-white/10":
        ...
        props.className
                ...
                onClick={(event: React.MouseEvent) => {
                    ...
                    navTo(props.menu);
                    console.log("the item ==> ", props.menu)
        ...
        <Lucide icon={props.menu.icon} className={"h-4 w-4 mr-2"}/>
